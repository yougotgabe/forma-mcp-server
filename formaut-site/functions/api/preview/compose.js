// functions/api/preview/compose.js
// Pages Function proxy for Formaut preview composition.
// Browser calls:   /api/preview/compose
// Platform Worker: /preview/compose
...
export async function onRequest(context) {
  ...
  let upstream;
  try {
    upstream = await fetch(`${workerBase}/preview/compose`, {
      method: 'POST',
      headers,
      body: bodyText,
    });
