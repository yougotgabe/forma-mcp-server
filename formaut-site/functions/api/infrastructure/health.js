// functions/api/infrastructure/health.js
// Runs the health check and optionally persists results. Runtime tier only
// typically calls this — standard/pro see aggregate status via /status.
...
export async function onRequest(context) {
  ...
  try {
    const wr = await fetch(`${env.PLATFORM_WORKER_URL}/infrastructure/health`, {
      ...
      body:    JSON.stringify({ slug, persist: body.persist === true }),
    });
